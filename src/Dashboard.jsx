...
const Dashboard = ({
  ...
  doYouOfferSameDayDelivery = (
    <>
      <strong className={styles.doYouOfferSameDayDeliveryEmphasis1}>
        Do you offer{" "}
      </strong>
      Same Day Delivery
      <strong className={styles.doYouOfferSameDayDeliveryEmphasis1}>?</strong>
    </>
  ),
  ...
  onceYouClickSubmitOrderOnTheChe = "Once you click \"Submit Order\" on the Checkout screen, your order has been completed. After that, we cannot guarantee that we will be able to make any changes.",
  callForMoreInfo = "Please call for more information. We will do our best to assist you.",
  bjsCallAssistance8664257932 = (
    <>
      call assistance <br />{" "}
      <strong className={styles.bjsCallAssistance8664257932Emphasis2}>
        111-111-1111
      </strong>
    </>
  ),
  wouldYouLikeMeToShowYouHowToCan = (
    <>
      ...
      <strong
        className={styles.wouldYouLikeMeToShowYouHowToCancelYourOrderEmphasis2}
      >
        cancel your order?
      </strong>
    </>
      ...
      <div className={styles.leftSection}>
        <div className={styles.profileSection}>
          <div className={styles.profileContainer}>
            ...
            <div className={styles.profilInfoContainer}>
              <p className={styles.profilName}>{profilName}</p>
              <div className={styles.parcelsPendingContainer}>
                <p className={styles.firstPart}>{firstPart}</p>
                <div className={styles.parcelsPendingCount}>
                  <p className={styles.parcelPendingCount}>
                    {parcelPendingCount}
                  </p>
                </div>
                <p className={styles.firstPart}>{secondPart}</p>
              </div>
            </div>
          </div>
          <div className={styles.profilInfoContainer}>
            <div className={styles.recentOrdersTitleContainer}>
              <p className={styles.recentOrderTitle}>{recentOrderTitle}</p>
            ...
            <div className={styles.recentOrdersTable}>
              <div className={styles.tableHeadings}>
                <p className={styles.tabTitle}>{tabTitle}</p>
              ...
              <div className={styles.tableRow}>
                ...
                <div className={styles.packingLabel}>
                  ...
                  <p className={styles.packingText}>{packingText}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{textLink}</p>
                  <img
                    alt=""
              ...
              <div className={styles.tableRow}>
                ...
                <div className={styles.inTransitLabel}>
                  ...
                  <p className={styles.inTransitText}>{inTransitText}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{textLinkTwo}</p>
                  <img
                    alt=""
              ...
              <div className={styles.tableRow}>
                ...
                <div className={styles.deliveredLabel}>
                  ...
                  <p className={styles.deliveredText}>{deliveredText}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{viewDetails}</p>
                  <img
                    alt=""
              ...
              <div className={styles.tableRowDelimiter} />
              <div className={styles.tableRow}>
                <p className={styles.date}>{sept42020Two}</p>
                <p className={styles.price}>{num1229Three}</p>
                <div className={styles.deliveredLabel}>
                  <div className={styles.greenDot} />
                  <p className={styles.deliveredText}>{delivered}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{viewDetailsTwo}</p>
                  <img
                    alt=""
              ...
              <div className={styles.tableRowDelimiter} />
              <div className={styles.tableRow}>
                <p className={styles.date}>{sept42020Three}</p>
                <p className={styles.price}>{num1229Four}</p>
                <div className={styles.deliveredLabel}>
                  <div className={styles.greenDot} />
                  <p className={styles.deliveredText}>{deliveredTwo}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{viewDetailsThree}</p>
                  <img
                    alt=""
              ...
              <div className={styles.tableRowDelimiter} />
              <div className={styles.tableRow}>
                <p className={styles.date}>{sept42020Four}</p>
                <p className={styles.price}>{num1229Five}</p>
                <div className={styles.deliveredLabel}>
                  <div className={styles.greenDot} />
                  <p className={styles.deliveredText}>{deliveredThree}</p>
                </div>
                <div className={styles.detailsLink}>
                  <p className={styles.textLink}>{viewDetailsFour}</p>
                  <img
                    alt=""
        ...
        <div className={styles.profileSection}>
          <div className={styles.questionTabs}>
            <p className={styles.topQuestions}>{topQuestions}</p>
            <p className={styles.yourQuestionHistory}>{yourQuestionHistory}</p>
          </div>
          <img
            alt=""
        ...
        <div className={styles.group5}>
          <div className={styles.frame3}>
            <div className={styles.questionContainer}>
              <p className={styles.doYouOfferSameDayDelivery}>
                {doYouOfferSameDayDelivery}
              </p>
            </div>
            <div className={styles.questionContainer}>
          ...
          <div className={styles.profilInfoContainer}>
            <div className={styles.sumupContainer}>
              <div className={styles.askedContainer}>
                <p className={styles.youveAsked}>{youveAsked}</p>
              ...
              />
              <div className={styles.profilInfoContainer}>
                <p className={styles.onceYouClickSubmitOrderOnTheChe}>
                  {onceYouClickSubmitOrderOnTheChe}
                </p>
                <br>
                
                </br>
                <p className={styles.onceYouClickSubmitOrderOnTheChe}>{callForMoreInfo}</p>
                ...
                <div className={styles.profilInfoContainer}>
                  <p className={styles.wouldYouLikeMeToShowYouHowToCan}>
                    {wouldYouLikeMeToShowYouHowToCan}
                  </p>
                  <div className={styles.orderButtonsContainer}>
                    ...
                    <button className={styles.greenButton}>
                      <p className={styles.buttonLabel}>{yes}</p>
                    </button>
                  </div>
                </div>
              </div>
